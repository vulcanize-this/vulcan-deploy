...
import PoolAddressesProviderRegistry from "../artifacts/contracts/protocol/configuration/PoolAddressesProviderRegistry.sol/PoolAddressesProviderRegistry.json";
...
export const deployRegistry = createDeployment({
    ...
    artifact: PoolAddressesProviderRegistry,
    argsFn(state, {owner}) {
        if (owner === undefined) {
